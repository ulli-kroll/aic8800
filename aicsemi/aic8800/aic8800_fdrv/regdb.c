	...
	.reg_rules =
		{
			...
			REG_RULE_EXT(5250, 5350, 80, 0, 20, 0,
						 NL80211_RRF_DFS | NL80211_RRF_AUTO_BW | NL80211_RRF_NO_OUTDOOR | 0),
			REG_RULE_EXT(5470, 5600, 80, 0, 27, 0, NL80211_RRF_DFS | 0),
			REG_RULE_EXT(5650, 5730, 80, 0, 27, 0, NL80211_RRF_DFS | 0),
			REG_RULE_EXT(5730, 5850, 80, 0, 36, 0, NL80211_RRF_AUTO_BW | 0),
			REG_RULE_EXT(5850, 5875, 20, 0, 14, 0, NL80211_RRF_AUTO_BW | 0),
			REG_RULE_EXT(5925, 6425, 160, 0, 24, 0, NL80211_RRF_NO_OUTDOOR | 0),
			REG_RULE_EXT(57000, 71000, 2160, 0, 43, 0, NL80211_RRF_NO_OUTDOOR | 0),
		},
	.n_reg_rules = 9};
	...
	.reg_rules =
		{
			...
			REG_RULE_EXT(5150, 5250, 80, 0, 27, 0, NL80211_RRF_AUTO_BW | NL80211_RRF_NO_OUTDOOR | 0),
			REG_RULE_EXT(5250, 5350, 80, 0, 27, 0,
						 NL80211_RRF_DFS | NL80211_RRF_AUTO_BW | NL80211_RRF_NO_OUTDOOR | 0),
			REG_RULE_EXT(5470, 5725, 160, 0, 27, 0, NL80211_RRF_DFS | NL80211_RRF_AUTO_BW | 0),
			REG_RULE_EXT(5725, 5850, 80, 0, 30, 0, NL80211_RRF_AUTO_BW | 0),
			REG_RULE_EXT(5925, 7125, 320, 0, 12, 0, NL80211_RRF_NO_OUTDOOR | NL80211_RRF_NO_IR | 0),
	...
	.reg_rules =
		{
			...
			REG_RULE_EXT(5250, 5350, 80, 0, 24, 0,
						 NL80211_RRF_DFS | NL80211_RRF_AUTO_BW | 0),
			REG_RULE_EXT(5470, 5600, 80, 0, 24, 0, NL80211_RRF_DFS | 0),
			REG_RULE_EXT(5650, 5730, 80, 0, 24, 0, NL80211_RRF_DFS | 0),
			REG_RULE_EXT(5735, 5835, 80, 0, 30, 0, 0),
	...
	.reg_rules =
		{
			...
			REG_RULE_EXT(5150, 5350, 80, 0, 23, 0, NL80211_RRF_NO_IR | NL80211_RRF_NO_OUTDOOR | 0),
...
static const struct ieee80211_regdomain regdom_EC = {
	...
	.reg_rules =
		{
			REG_RULE_EXT(2400, 2483, 40, 0, 30, 0, 0),
			REG_RULE_EXT(5150, 5250, 80, 0, 17, 0, NL80211_RRF_AUTO_BW | NL80211_RRF_DFS | 0),
			REG_RULE_EXT(5250, 5350, 80, 0, 21, 0, NL80211_RRF_DFS | NL80211_RRF_AUTO_BW | 0),
	...
	.reg_rules =
		{
			...
			REG_RULE_EXT(5250, 5350, 80, 0, 20, 0, NL80211_RRF_DFS | NL80211_RRF_AUTO_BW | 0),
			REG_RULE_EXT(57000, 66000, 2160, 0, 40, 0, 0),
		},
	.n_reg_rules = 4};
	...
	.reg_rules =
		{
			REG_RULE_EXT(2402, 2482, 40, 0, 20, 0, 0),
			REG_RULE_EXT(5170, 5250, 80, 0, 20, 0, NL80211_RRF_AUTO_BW | 0),
			REG_RULE_EXT(5250, 5330, 80, 0, 20, 0, NL80211_RRF_DFS | NL80211_RRF_AUTO_BW | 0),
			REG_RULE_EXT(5490, 5710, 160, 0, 27, 0, NL80211_RRF_DFS | 0),
		},
	.n_reg_rules = 4};
	...
	.reg_rules =
		{
			...
			REG_RULE_EXT(5250, 5350, 80, 0, 20, 0,
						 NL80211_RRF_NO_OUTDOOR | NL80211_RRF_DFS |
							 NL80211_RRF_AUTO_BW | 0),
			REG_RULE_EXT(5470, 5725, 160, 0, 20, 0, NL80211_RRF_DFS | NL80211_RRF_NO_OUTDOOR | 0),
...
static const struct ieee80211_regdomain regdom_NG = {
	...
	.reg_rules =
		{
			REG_RULE_EXT(2402, 2482, 40, 0, 20, 0, 0),
			REG_RULE_EXT(5250, 5330, 80, 0, 20, 0, NL80211_RRF_DFS | 0),
			REG_RULE_EXT(5735, 5835, 80, 0, 30, 0, 0),
		},
	.n_reg_rules = 3};
...
static const struct ieee80211_regdomain regdom_RU = {
	...
	.reg_rules =
		{
			REG_RULE_EXT(2400, 2483, 40, 0, 20, 0, 0),
			REG_RULE_EXT(5150, 5350, 160, 0, 20, 0, NL80211_RRF_NO_OUTDOOR | 0),
			REG_RULE_EXT(5650, 5850, 160, 0, 20, 0, NL80211_RRF_NO_OUTDOOR | 0),
			REG_RULE_EXT(5925, 6425, 160, 0, 20, 0, NL80211_RRF_NO_OUTDOOR | 0),
