...
enum p2p_action_type {
    P2P_ACTION_GO_NEG_REQ = 0,
    P2P_ACTION_GO_NEG_RSP,
    P2P_ACTION_GO_NEG_CFM,
    P2P_ACTION_INVIT_REQ,
    P2P_ACTION_INVIT_RSP,
    P2P_ACTION_DEV_DISC_REQ,
    P2P_ACTION_DEV_DISC_RSP,
    P2P_ACTION_PROV_DISC_REQ,
    P2P_ACTION_PROV_DISC_RSP,
};
