...
aic_btusb-y := \
	aicsemi/aic_btusb/aic_btusb.o

aic_btusb-$(CONFIG_SUPPORT_VENDOR_APCF) += \
	aicsemi/aic_btusb/aic_btusb_external_featrue.o
...
obj-$(CONFIG_AIC8800_BTUSB_SUPPORT) += aic_btusb.o
